...
| E02D02.1   | Identifier type              |        | 1       | Code                                                | LCF code list **IMI**                                                                                                                                                                                                                                                                                                                         
...
| E02D07     | Item sensitive media warning |        | 1       | Code                                                | LCF code list **MEW**                                                                                                                                                                                                                                                                                                                         
                                                                                                                      Flag indicating that the item contains a media component that is sensitive to some security setting devices.                                                                                                                                                                                                                                   |
| E02D08     | Desensitize item security    |        | 0-1     | Code                                                | LCF code list **SCD**                                                                                                                                                                                                                                                                                                                         
                                                                                                                      Flag indicating that the security should or should not be desensitized / removed on check-out.                                                                                                                                                                                                                                                 |
...
| E02D09.1   | Restriction type             |        | 1       | <span id="h.1fob9te" class="anchor"></span>Code     | LCF code list **CRT**                                                                                                                                                                                                                                                                                                                         |
...
| E02D10.1   | Fee type                     | BT     | 1       | <span id="h.3znysh7" class="anchor"></span>Code     | LCF code list **CHT**                                                                                                                                                                                                                                                                                                                         |
| E02D10.2   | Fee amount                   | BV     | 1       | Value                                               | Currency value                                                                                                                                                                                                                                                                                                                                |
| E02D10.3   | Fee currency                 | BH     | 0-1     | Code                                                | ISO three-letter currency code, e.g. ‘GBP’                                                                                                                                                                                                                                                                                                    |
| **E02D11** | **Circulation status**       |        | **1**   | <span id="h.2et92p0" class="anchor"></span>**Code** | **LCF code list CIS**                                                                                                                                                                                                                                                                                                                         |
...
| E02D13     | Number of patrons            
              in hold queue                 | CF     | 0-1     | Integer                                             | Included only if this specific item is specified in the hold queue.                                                                                                                                                                                                                                                                           |
...
| **E03D04.1** | **Condition**                                           |        | **1-n** | <span id="h.tyjcwt" class="anchor"></span>**Code** | **LCF code list PNS**                                                                                                                                                   |
...
| E03D20.1     | Charge type                                             | BT     | 0-1     | <span id="h.3dy6vkm" class="anchor"></span>Code    | LCF code list **CHT**                                                                                                                                                   
                                                                                                                                                  May only be omitted if there is only one occurrence of the charge limit composite, in which case the amount is the limit on the aggregate of charges of all types.       |
