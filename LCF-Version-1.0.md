...
| E01D05.1   | Contributor role                                |       | 1          | Code       | Contributor role code from ONIX Code List 17[6].                                                                                                                                                                                                                                                         |
...
| E01D15     | Number of patrons in hold queue                 | CF    | 0-1R[5]        | Integer    |                                                                                                                                                                                                                                                                                                          |
...
| E03D05       | Library card status                                     |        | 0-1     | Code                                               | LCF code list **PCS**<br/>Only codes '02' and '03' would be relevant in this context.   |
...
[5] NOTE - Elements where the cardinality is followed by 'R' are "response-only" or "read-only". These elements should only occur in responses from an LMS to a terminal application/device and will be ignored when included in requests.

[6] The ONIX code lists are maintained by EDItEUR. For the latest issue of the ONIX code lists see [*http://www.editeur.org/14/Code-Lists/*](numbering.xml).