...
| E03D25       | Barcode identifier                                      |        | 0-1     | String                                             | The identifier on the patron's library card. Mandatory unless the primary LMS identifier is the same identifier.<br/>*Added v1.0.1*                                                                                             |
| *E03D26*     | *Additional identifier*                                 |        | 0-n   |                                                  |                            | Composite element containing details of an additional identifier for this patron.                                                                                                                                                                                                                                                               |
| E03D26.1   | Identifier type              |        | 1       | Code                                                | LCF code list **IMI**<br/>The identification scheme.                                                                                                                                                                                                                                                                                                                     |
| E02D26.2   | Identifier type name         |        | 0-1     | String                                              | If the identification scheme is proprietary, the name of the scheme.                                                                                                                                                                                                                                                                          |
| E02D26.3   | Identifier value             |        | 1       | String                                              | The identifier string.                                                                                                                                                                                                                                                                                                                        |
