...
| **E14D03** | **Authority / institution name** |     | **1**    | **String** | **The name of this authority/institution**                                                                                        |
| E14D08     | Library statutory status   |           | 0-1      | Code        | LCF code list **[LST](LCF-CodeLists.md#LST)**<br/>*Added v1.2.0*         |
| E14D09     | Library type               |           | 0-1      | Code        | LCF code list **[LTY](LCF-CodeLists.md#LTY)**<br/>*Added v1.2.0*         |
