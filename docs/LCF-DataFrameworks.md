...
| Q02D06     | Requested entity list type |            | 0-1     | Code      | LCF code list **[ELI](LCF-CodeLists.md#ELI)**<br/>Indicates whether the response should contain a list of entity identifiers (R02D06) or a list of embedded entities (R02C07).<br/>*Added in v1.2.0* |
