...
| R00D05.2   | Reason request denied      |            | 0-1     | Code      | LCF code list **[RDN](LCF-CodeLists.md#RDN)**<br/>Used if R00D05.1 contains code '08' (RDN08 request denied)                                                                       |
...
| R00D06.3   | Acknowledgement code       |            | 0-1     | String    | Library-specific code to be included in a repeat request, for the request to be accepted; only included if R00D05.2 contains code '10'  (RDN10 request requires acknowledgement)<br/>*Added in v1.3.0* |
