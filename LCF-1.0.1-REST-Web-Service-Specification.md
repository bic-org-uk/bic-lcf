...
| 6     | Q02D02.1     |                       | {selection-criterion-code}| 0-n | Variable    | Each query parameter name must be a selection criterion identifier as specified in code list [[SEL\|LCF-Code-Lists#SEL]] *[v1.0.1]*. The parameter value in each case corresponds to Q02D02.2.                                                         |
